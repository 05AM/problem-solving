...
class Solution {
    public int[] solution(int[][] edges) {
        ...
        // 전체 그래프의 수는 생성된 정점의 진출 차수와 같습니다.
        int totalGraphs = outDegree.get(createdVertex);
        // 도넛 모양 그래프의 수는 전체 그래프 수에서 막대와 8자 그래프 수를 뺀 값입니다.
